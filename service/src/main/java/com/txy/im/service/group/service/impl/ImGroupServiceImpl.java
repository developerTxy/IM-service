...
import com.txy.im.codec.pack.group.CreateGroupPack;
import com.txy.im.codec.pack.group.DestroyGroupPack;
import com.txy.im.codec.pack.group.UpdateGroupInfoPack;
...
import com.txy.im.service.conversation.dao.ImConversationSetEntity;
import com.txy.im.service.group.dao.ImGroupEntity;
import com.txy.im.service.group.dao.mapper.ImGroupMapper;
import com.txy.im.service.group.model.callback.DestroyGroupCallbackDto;
import com.txy.im.service.group.model.req.*;
import com.txy.im.service.group.model.resp.GetGroupResp;
import com.txy.im.service.group.model.resp.GetJoinedGroupResp;
...
public class ImGroupServiceImpl implements ImGroupService {
    ...
    public ResponseVO importGroup(ImportGroupReq req) {
        ...
        if (StringUtils.isEmpty(req.getGroupId())) {
            ...
            Integer integer = Math.toIntExact(imGroupDataMapper.selectCount(query));
            if (integer > 0) {
