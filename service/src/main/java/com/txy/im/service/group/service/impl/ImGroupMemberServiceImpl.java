package com.txy.im.service.group.service.impl;
...
import com.txy.im.codec.pack.group.GroupMemberSpeakPack;
...
import com.txy.im.common.enums.GroupErrorCode;
import com.txy.im.common.enums.GroupMemberRoleEnum;
import com.txy.im.common.enums.GroupStatusEnum;
import com.txy.im.common.enums.GroupTypeEnum;
...
import com.txy.im.service.group.dao.ImGroupMemberEntity;
import com.txy.im.service.group.dao.mapper.ImGroupMemberMapper;
import com.txy.im.service.group.model.callback.AddMemberAfterCallback;
import com.txy.im.service.group.model.callback.DestroyGroupCallbackDto;
import com.txy.im.service.group.model.req.*;
import com.txy.im.service.group.model.resp.AddMemberResp;
...
import com.txy.im.service.utils.GroupMessageProducer;
...
public class ImGroupMemberServiceImpl implements ImGroupMemberService {
    ...
    /**
     * @param
     * @return com.txy.im.common.ResponseVO
    ...
    public ResponseVO addGroupMember(String groupId, Integer appId, GroupMemberDto dto) {
        ...
        if (dto.getRole() != null && GroupMemberRoleEnum.OWNER.getCode() == dto.getRole()) {
            ...
            Integer ownerNum = Math.toIntExact(imGroupMemberMapper.selectCount(queryOwner));
            if (ownerNum > 0) {
     ...
     * @return com.txy.im.common.ResponseVO<com.txy.im.service.group.model.resp.GetRoleInGroupResp>
    ...
    public ResponseVO addMember(AddGroupMemberReq req) {
        ...
        //添加完成 回调服务端
        if(appConfig.isAddG/roupMemberAfterCallback()){
