...
import com.txy.im.common.enums.DeviceMultiLoginEnum;
    ...
    public void listenerUserLogin(){
        ...
        topic.addListener(String.class, new MessageListener<String>() {
            ...
            public void onMessage(CharSequence charSequence, String msg) {
                ...
                List<NioSocketChannel> nioSocketChannels = (List<NioSocketChannel>) SessionSocketHolder.get(dto.getAppId(), dto.getUserId(),dto.getClientType(), dto.getImei());
